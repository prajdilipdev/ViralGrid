...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-ink-950 text-white flex flex-col lg:flex-row">
      <div className="flex-1 flex flex-col justify-center px-8 sm:px-16 lg:px-24 py-16 border-b lg:border-b-0 lg:border-r border-white/10 relative overflow-hidden">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-3 mb-8">
            ...
            <span className="text-xl tracking-tight font-semibold">ViralGrid</span>
          </div>
          <p className="text-xs tracking-[0.3em] uppercase text-white/50 mb-6 font-semibold">Private Publishing Suite</p>
          <h1 className="text-4xl sm:text-5xl lg:text-6xl tracking-tighter font-light leading-[1.05]">
            One upload.<br />
      ...
      <div className="w-full lg:w-[480px] flex flex-col justify-center px-8 sm:px-14 py-16 bg-ink-900">
        <h2 className="text-2xl sm:text-3xl tracking-tight font-medium mb-2">Sign in</h2>
        ...
        <button
          ...
          onClick={handleLogin}
          /* Stays white with the Google mark — the accent treatment would
             breach Google's sign-in button branding guidelines. */
          className="vg-btn w-full h-12 bg-[#F4F3EC] text-[#0A0A09] font-medium rounded-md flex items-center justify-center gap-3 hover:-translate-y-0.5 active:scale-[0.98]"
        >
        ...
        <div className="mt-12 grid grid-cols-2 gap-px bg-white/10 border border-white/10">
          {[
            ...
            <div key={label} className="bg-ink-900 p-4 flex items-center gap-3">
